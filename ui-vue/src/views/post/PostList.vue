    ...
    <el-row :gutter="20">
      ...
      <el-col :lg="18" :md="17">
        <div class="post-list-container">
          ...
          <el-empty description="暂无文章" v-if="!loading && posts.length === 0" />
      ...
      <!-- Right Sidebar -->
      <el-col :lg="6" :md="7" class="hidden-sm-and-down">
        <HotPosts />
      </el-col>
    </el-row>
  </div>
...
watch(() => route.query.search, (newSearchQuery, oldSearchQuery) => {
...
.post-content {
  padding: 0; /* Handled by el-card body */
}
